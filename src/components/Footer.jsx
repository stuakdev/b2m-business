      ...
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div className="flex md:flex-col items-end gap-4">
          <a
            ...
            href="https://www.facebook.com/share/1FdyQYTq8t/?mibextid=wwXIfr"
            className="text-white/90 w-12 h-12 flex items-center justify-center"
          >
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://www.linkedin.com/in/rathika-mahadeva-30142637a"
            className="text-white/90 w-12 h-12 flex items-center justify-center"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 640 640">
